...
import MeatballHero from "./five-ball.jpg";
...
const Delivery = () => (
  <div>
    <Helmet>
      ...
      <meta
        name="description"
        content="Pickup from the store or sit back and enjoy the couch with delivery."
      />
    </Helmet>
    <ShortHero image={MeatballHero} headline="Order Online" />
    <Container>
      <Box color="#84bf5b">
        <BoxHeader color="#84bf5b">Pickup</BoxHeader>Want to pickup your order
        directly from the Stoppe? Orders typically ready in ~30mins.
        <PushDown>
