...
const AddToCart = observer(({ shoppingCart, itemStore, closeFunc }) => {
  ...
  return (
    <Container
      ...
      ready={itemStore.readyForCart}
      onClick={addItemsToCart}
    >
      <CartCountContainer
        onMouseEnter={() =>
          itemStore.readyForCart && setHighlightColor("#902e2d")
        }
        onMouseLeave={() =>
          itemStore.readyForCart && setHighlightColor("#ae3635")
        }
      ...
      <span>
        {itemStore.readyForCart ? "Add to Cart" : <i>Make selections</i>}
      </span>
