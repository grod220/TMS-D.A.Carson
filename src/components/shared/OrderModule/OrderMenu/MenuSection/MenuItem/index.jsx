...
import formatPrice from "../../../../../../sharedUtilities/addZero.js";
...
const ItemContainer = styled.div`
  border: ${({ hasItem }) =>
    hasItem ? "3px solid #84bf5b" : "1px solid #cecece"};
  min-height: 120px;
  display: flex;
...
const MenuItem = ({ itemData, category }) => {
  ...
  const itemCount = OrderStore.shoppingCart.filter(
    item => item.dishName === itemData.name
  ).length;
  return (
    <>
      {modal && (
