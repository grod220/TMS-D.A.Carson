...
const BodyText = () => (
  <Container>
    Let The Meatball Stoppe help you create menus to suit your many catering
    needs! We are your missing ingredient for your event.
    <ul>
      <li>
        <Highlight i>Corporate Catering</Highlight> - The Meatball Stoppe's
      ...
      <li>
        <Highlight i>
          Private Cooking Classes - Corporate Team Building, Client Appreciation
        </Highlight>{" "}
